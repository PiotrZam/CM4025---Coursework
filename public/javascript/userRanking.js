...
$(document).ready(async function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data.length === 0) {
                var noStoriesMsg = '<h2>No stories have been uploaded by logged in users yet</h2>'; 
                topUsersListDiv.append(noStoriesMsg);
            }
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data.length === 0) {
                var noStoriesMsg = '<h2>No stories have been rated yet</h2>'; 
                topUsersListDiv.append(noStoriesMsg);
            }
